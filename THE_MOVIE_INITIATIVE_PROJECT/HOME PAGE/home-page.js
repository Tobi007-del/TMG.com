...
function displayNotification(txt){
  ...
  const options = {
    ...
    image: "/TMG.com/THE_MOVIE_INITIATIVE_PROJECT/SPARE-PICS/justice-league-b-s.jpeg",
    actions: [
        {
            action: 'open-site',
  ...
  if (Notification?.permission === "granted") {
    ...
    // body: `${txt} to The Movie Garden. We are now live and you can watch all your exclusive movies and tv shows!!!` , icon: "/TMG.com/THE_MOVIE_INITIATIVE_PROJECT/SPARE-PICS/movieicon-two.jpeg"
    // })
...
function displayReturnNotification(){
    ...
    if (Notification?.permission === "granted") {
        // let n = new Notification("THE MOVIE GARDEN", {
        //   body: `${localStorage.greetGardener} to The Movie Garden once more. You now know where you can watch all your exclusive movies and tv shows so tour the site and enjoy!` , icon: "/TMG.com/THE_MOVIE_INITIATIVE_PROJECT/SPARE-PICS/movieicon-two.jpeg"
        // });
        navigator.serviceWorker.ready.then(function(registration) {
...
function lightMode() {
    ...
    if(lightItems.length === 0 && localStorage.greetGardener === UNIQUE_TEXT && ((localStorage.picsrc === UNIQUE_IMAGE_D) || (localStorage.picsrc === UNIQUE_IMAGE_L))){
      ...
      localStorage.picsrc = UNIQUE_IMAGE_L;
      console.log(localStorage.greetGardener);
    } else if (lightItems.length === 0 && ((localStorage.picsrc === undefined) || (localStorage.picsrc === "/TMG.com/THE_MOVIE_INITIATIVE_PROJECT/SPARE-PICS/person_one.jpg"))){
        ...
        console.log(localStorage.greetGardener);
    } else if (lightItems.length > 0 && ((localStorage.picsrc === "/TMG.com/THE_MOVIE_INITIATIVE_PROJECT/SPARE-PICS/person.png") || (localStorage.picsrc === "/TMG.com/THE_MOVIE_INITIATIVE_PROJECT/SPARE-PICS/person_one.jpg") || (localStorage.picsrc === undefined))){
      document.getElementById("user-image").src = "/TMG.com/THE_MOVIE_INITIATIVE_PROJECT/SPARE-PICS/person_one.jpg";
      localStorage.picsrc = "/TMG.com/THE_MOVIE_INITIATIVE_PROJECT/SPARE-PICS/person_one.jpg";
      console.log(localStorage.greetGardener);
    }
} 
...
function Category(genre, genrename, nav) {
    ...
    if (genrename === "about"){
        document.getElementById("about-site").style.display="flex";
        noMovingPicture(t);
    }
    }}
}
